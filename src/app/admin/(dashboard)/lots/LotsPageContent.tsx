    ...
    <>
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <p className="text-[11px] font-medium tracking-[0.15em] uppercase text-[#6b6b6b] mb-1">
              BOUTIQUE / PAR BUDGET
            </p>
            <h1 className="font-[family-name:var(--font-stack)] text-3xl text-[#000000]">
              Lots de prix
            </h1>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {/* Lots Actifs */}
          <div className="bg-[#fafafa] rounded-lg p-5 border border-[#e8ddd4]">
            <p className="text-[10px] font-medium tracking-[0.12em] uppercase text-[#6b6b6b] mb-3">
              LOTS ACTIFS
            </p>
            <p className="font-[family-name:var(--font-stack)] text-4xl text-[#000000] mb-1">
          ...
          <div className="bg-[#f5ebe3] rounded-lg p-5 border border-[#e0d0c4]">
            ...
            <p className="font-[family-name:var(--font-stack)] text-4xl text-[#7a3d48] mb-1">
              {outOfStockItems}
            </p>
            <p className="text-[13px] text-[#6b6b6b]">
              Affichés « Épuisé »
        ...
        <div className="bg-white rounded-xl border border-[#e8ddd4] overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 border-b border-[#e8ddd4]">
            <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase text-[#000000]">
              TOUS LES LOTS
            </h2>
              ...
              <button
                ...
                className={clsx(
                  ...
                  !filter
                    ...
                    : "bg-white text-[#000000] border border-[#e8ddd4] hover:bg-[#fafafa]"
                )}
              >
                TOUT
              </button>
          ...
          {filteredLots.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              {/* Column Headers */}
              <div className="hidden md:grid grid-cols-[1fr_120px_100px_100px_100px_50px] gap-4 px-5 py-3 bg-[#fafafa] border-b border-[#e8ddd4] text-[10px] font-semibold tracking-[0.12em] uppercase text-[#6b6b6b]">
                <div>LOT</div>
                <div>PRIX</div>
                <div>ARTICLES</div>
                <div>STOCK</div>
              ...
              {filteredLots.map((lot) => (
                <div
                  ...
                  className={clsx(
                    "grid grid-cols-1 md:grid-cols-[1fr_120px_100px_100px_100px_50px] gap-4 px-5 py-4 border-b border-[#e8ddd4] items-center cursor-pointer transition-colors hover:bg-[#fafafa]",
                    loadingId === lot.id && "opacity-50 pointer-events-none",
                    selectedLotId === lot.id && "border-l-4 border-l-[#511f29] bg-[#fafafa]"
                  )}
                >
                  {/* Lot Info */}
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {lot.category && (
                        <p className="text-[13px] text-[#6b6b6b]">{lot.category.name}</p>
                      )}
                    </div>
                  </div>
