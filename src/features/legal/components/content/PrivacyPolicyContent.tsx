export function PrivacyPolicyContent() {
  return (
    <>
      <h2>Introduction</h2>
      <p>
        Chez SO&apos;MAYA, nous accordons une grande importance à la protection de vos données personnelles. Cette
        politique de confidentialité explique comment nous collectons, utilisons et protégeons vos informations lorsque
        vous visitez notre site web ou effectuez des achats.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Informations de livraison :</strong> adresse postale, commune, ville
        </li>
        <li>
          <strong>Informations de commande :</strong> produits commandés, historique d&apos;achats
        </li>
        <li>
      ...
      <p>
        Nous ne vendons jamais vos données personnelles à des tiers. Vos informations peuvent être partagées uniquement
        avec :
      </p>
      <ul>
      ...
      <p>
        ...
        autorisé, modification, divulgation ou destruction. Notre site utilise le protocole HTTPS pour sécuriser vos
        échanges.
      </p>
      ...
      <p>
        Pour exercer ces droits, contactez-nous via WhatsApp au +225 05 08 90 56 66 ou par téléphone au +225 07 78 78 42
        68.
      </p>

      <h2>Cookies</h2>
      <p>
        Notre site utilise des cookies essentiels pour assurer son bon fonctionnement. Ces cookies permettent de
        mémoriser votre panier et vos préférences de navigation.
      </p>

      <h2>Modifications</h2>
      <p>
        Nous pouvons mettre à jour cette politique de confidentialité occasionnellement. La date de dernière mise à jour
